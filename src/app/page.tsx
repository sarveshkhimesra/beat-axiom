...
export default function Home() {
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "clamp(48px, 12vw, 96px) clamp(20px, 5vw, 32px)", textAlign: "center" }}>
      ...
      <h1 className="font-mono-display" style={{ fontSize: "clamp(30px, 7vw, 48px)", marginTop: 16, lineHeight: 1.12 }}>
        Rahul Kothari built an AI to grade sales conversations <span className="accent-text">the way he does.</span>
      </h1>
