    ...
    <main style={{ maxWidth: 640, margin: "0 auto", padding: "clamp(40px, 10vw, 80px) clamp(16px, 5vw, 28px)", position: "relative" }}>
      ...
      <div className="terminal-window" style={{ padding: 0 }}>
        <div style={{ padding: "clamp(24px, 6vw, 40px) clamp(20px, 5vw, 32px)" }}>
          ...
          <div style={{ color: "var(--text-secondary)", fontSize: 13, marginBottom: 8 }}>axiom@beat ~ $</div>
          <h1 style={{ fontSize: "clamp(24px, 6vw, 38px)", lineHeight: 1.2, margin: "0 0 20px 0" }}>
            A dynamic sales simulation. <span className="accent-text glow">Prove you can close.</span>
          </h1>
          <p style={{ color: "var(--text-secondary)", fontSize: "clamp(14px, 3.8vw, 17px)", margin: "0 0 32px 0" }}>
            Real buyers. Real objections. Stage-by-stage progression. AXIOM scores everything.
          </p>
          <Link href="/duel" className="glow-box" style={{ display: "inline-block", padding: "14px 28px", background: "var(--accent-primary)", color: "#040d08", borderRadius: 8, fontSize: 17, fontWeight: 700, textDecoration: "none", letterSpacing: "0.03em" }}>
