...
export const CLIENT_SCENARIOS: Record<ScenarioId, ClientScenario> = {
  "skeptical-vp": {
    ...
    setup: "You're selling a team-productivity platform to a VP of Operations who was burned by a tool rollout that died in adoption. You have ~7 messages to win the deal.",
  ...
  "cutting-cfo": {
    ...
    setup: "You're selling a managed-service engagement to a CFO under board pressure to cut spend. You have ~7 messages to win the deal.",
  ...
  "committee-gatekeeper": {
    ...
    setup: "You're selling an enterprise platform to a procurement-minded gatekeeper running a formal evaluation. You have ~7 messages to win the deal.",
  ...
  "enthusiastic-champion": {
    ...
    setup: "You're selling a workflow-automation platform to an internal champion who loves you — but can't sign. You have ~7 messages to win the deal.",
  ...
  "silent-evaluator": {
    ...
    setup: "You're selling a dev-infrastructure platform to a principal engineer who barely speaks. You have ~7 messages to win the deal.",
